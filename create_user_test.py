...
def test_create_user_16_letter_in_first_name_get_bad_request():
    negative_assert_symbol("Аааааааааааааааа");

def test_create_user_spaces_in_first_name_get_bad_request():
    negative_assert_symbol("Человек и Ко");

def test_create_user_special_char_in_first_name_get_bad_request():
    negative_assert_symbol("№%@");

def test_create_user_has_number_in_first_name_get_bad_request():
